...
def generate_launch_description():
    ...
    yaml_path = os.path.join(robot_bringup_path, "config", "zuihouinitred.yaml")
    ...
    point_lio_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [point_lio_path, "/launch", "/pointlio_zuihouinitred.launch.py"]
        ),
    )
    ...
    # body_to_odom = Node( #导航的base_link坐标系（底盘中心）到自瞄的odom坐标系（云台中心）
    #     package='tf2_ros',
    #     executable='static_transform_publisher',
    #     name='body_to_odom_broadcaster',
    #     arguments=['0', '0', '0.45',  '0', '0', '0', '1','base_link', 'odom']
    # )
