...
private:
    ...
    */
    ...
    rclcpp::Subscription<rm_interfaces::msg::AngleError>::SharedPtr sub_angle_error_;
    ...
    builtin_interfaces::msg::Time angle_timestamp;
    ...
    std::unique_ptr<tf2_ros::TransformBroadcaster> base_link_tf_broadcaster;
    std::unique_ptr<tf2_ros::TransformBroadcaster> double_yaw_tf_broadcaster;
    ...
    double angle_between_gimbal_and_chassis = 0.0f;
    double angle_between_small_yaw_and_big_yaw = 0.0f;
    mutex mtx_buffer;
