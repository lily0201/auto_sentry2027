#ifndef IS_SENTRY_HURT_HPP_
#define IS_SENTRY_HURT_HPP_
...
namespace nav2_behavior_tree
{
     ...
     */
    class IsSentryHurtCondition : public BT::ConditionNode
    {
    public:
        /**
         ...
         */
        IsSentryHurtCondition(
            const std::string &condition_name,
            const BT::NodeConfiguration &conf);

        IsSentryHurtCondition() = delete;
