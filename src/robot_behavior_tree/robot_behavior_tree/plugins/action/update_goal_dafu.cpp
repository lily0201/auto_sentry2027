...
#include "robot_behavior_tree/plugins/action/update_goal_dafu.hpp"

namespace nav2_behavior_tree
{
    UpdateGoalDafuAction::UpdateGoalDafuAction(
    ...
    BT::NodeStatus UpdateGoalDafuAction::tick()
    {
        getInput("position_x",position_x);
        getInput("position_y",position_y);
        config().blackboard->get("if_dafu", if_dafu);
...
{
    factory.registerNodeType<nav2_behavior_tree::UpdateGoalDafuAction>("UpdateGoalDafu");
}
